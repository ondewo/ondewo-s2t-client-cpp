...
| ------------------------------------------- | ---------------------------------------------------------------------- |
| a message, a field or an RPC                | [ondewo-s2t-api](https://github.com/ondewo/ondewo-s2t-api)                     |
...
(`ONDEWO_S2T_API_GIT_BRANCH`, `ONDEWO_PROTO_COMPILER_GIT_BRANCH`) and regenerating.
